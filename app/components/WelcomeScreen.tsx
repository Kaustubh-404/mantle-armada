    ...
    <>
      ...
      {showModal && (
        ...
        >
          ...
          {/* Network Warning - Only show if connected but not on Mantle Testnet */}
          {isConnected && !isTestnet && (
            <div className="text-white text-sm bg-red-500/20 border border-red-500 rounded-md p-2">
              You're not connected to Mantle Sepolia Testnet. Please switch to Mantle Sepolia to play.
            </div>
          )}
        </Modal>
      )}
      ...
      {showAccountCreation && (
        ...
        />
          ...
          Made with love and rum on <a href="https://www.mantle.xyz/" target="_blank" className="text-[hsla(152,100%,62%,1)] !cursor-pointer">Mantle Network</a>  by <a href="http://github.com/Kaustubh-404/" target="_blank" className="text-[hsla(152,100%,62%,1)] !cursor-pointer">Kaustubh Pardeshi</a>
          </button>}
    </>
  );
}; 