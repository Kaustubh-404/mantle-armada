...
|----------|---------|---------|
| **MantleArmada** | `0xBeCab77F91FFF82A0f6a37cf5D7e04a2e723D6Fc` | Main game logic |
...
- **Faction Warfare**: Navy vs Pirates only
...
### ✅ Phase 2: Social & Progression (Completed)
- [x] Guild system
- [x] Battle Pass
- [x] ARMADA token
- [x] Ranking system

### ✅ Phase 3: NFT & DeFi (Completed)
- [x] Ship NFT minting
- [x] Yield generation
- [x] Staking system
- [x] Marketplace integration prep
...
### 🔮 Phase 5: RWA Evolution (Future)
- [ ] Tokenized bonds backed by guild treasuries
- [ ] Fractional Ship NFT ownership
- [ ] KYC integration for compliant trading
